...
# results['Tip per hour (melzar)'] = str("{:.2f}".format(melzar_tip))
results['Tip per hour (melzar)'] = str(round(melzar_tip,2))
...
recipients = ["pankinatlv@gmail.com","michelangelonaim@gmail.com"]
